...
//$cargo = "";
		...
		//$cargo = $_POST["cargo"];
			...
			$stmt->bind_param('ssssssssssssssss',$matricula, $nome, $email, $cpf, $cidade, $estado, $bairro, $cep, $logradouro, 
				$numero, $status, $datanascimento, $complemento, $senha, $sexo, $nivel);
			...
			$stmt3 = $obj_mysqli->prepare("INSERT INTO `professor`(`especializacao`,`instituicao_formacao`,`Matricula_pessoa`)VALUES(?,?,?)
											ON DUPLICATE KEY UPDATE especializacao = VALUES(especializacao),
											instituicao_formacao = VALUES(instituicao_formacao),
											Matricula_pessoa = VALUES(Matricula_pessoa)");
			$stmt3 ->bind_param('sss',$especializacao,$instituicao,$matricula);
			...
			if(!$stmt3->execute())
			{
				...
				header("Refresh: 2, professor.php");
				exit;
			}
