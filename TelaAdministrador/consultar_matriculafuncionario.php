...
$stmt = $obj_mysqli->prepare("SELECT pessoa.Matricula,pessoa.Nome_Completo,pessoa.CPF,pessoa.Data_Nascimento,pessoa.Sexo,pessoa.Email,pessoa.CEP,
telefone.Numero,telefone.Tipo,telefone.Numero_celular, funcionario.cargo , pessoa.Complemento, pessoa.Numero_endereco
FROM pessoa
INNER JOIN telefone ON pessoa.Matricula = telefone.Matricula_pessoa
INNER JOIN funcionario ON pessoa.Matricula = funcionario.Matricula_pessoa WHERE Matricula = ?");
