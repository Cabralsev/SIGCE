...
<form action = "inserefuncionario.php" style="padding: 10px" method="POST">
  <fieldset>
      <ol class="breadcrumb">
            <li class="breadcrumb-item active">Informações Pessoais</li>
          </ol>
<label for="matricula"><b>Matrícula</b></label>
    <input onblur="consulta()" type="text" maxlength="3" style="width:100px" class="form-control" placeholder="Matrícula" id="matricula"  name="matricula" required><br>
<SCRIPT>
   /* Executa a requisição quando o campo CEP perder o foco */
   $('#matricula').blur(function(){
           /* Configura a requisição AJAX */
           $.ajax({
                url : 'consultar_matriculafuncionario.php', /* URL que será chamada */ 
...
<label for="Status"><b>Status</b></label>
  ...
  <option value="inativo" name="status">Inativo</option>
  </select>

<label for="nivel"><b>Nivel</b></label>
<select name = "nivel">
  <option name ="nivel" value="3-Funcionario">Nivel de Usuario: Funcionário</option>
  </select>
